 ...
 * <ul>
 * <li>Apply Reversal Response - converts full reversal specific response to
 ...
 */
public interface IReverseResponseHandler<T, J> {
    /**
     * This method will be invoked by ReverseInfraService to convert response to
     ...
     * 
     * @param t Holds AdyenResponse object, reverse response from rest HttpClient
     * @return The PaymentCollectionOutput- Adapter's output object
     */
    J applyReverseResponse(T t);
}
