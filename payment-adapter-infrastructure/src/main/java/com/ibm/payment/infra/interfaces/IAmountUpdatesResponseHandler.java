 ...
 * <ul>
 * <li>Apply AmountUpdates Response - converts amend auth/amount updates
 * specific response to adapter's output object</li>
 * </ul>
 *
 ...
 */
public interface IAmountUpdatesResponseHandler<T, J> {

	/**
	 * This method will be invoked by AmendAuthInfraService to convert response to
	 ...
	 * 
	 * @param t holds AdyenResponse object, amend auth response from rest HttpClient
	 * @return The PaymentCollectionOutput- Adapter's output object
	 */
	J applyAmountUpdatesResponse(T t);
