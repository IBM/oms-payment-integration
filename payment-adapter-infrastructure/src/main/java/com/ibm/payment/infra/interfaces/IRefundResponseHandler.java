 ...
 * <ul>
 * <li>Apply Refund Response - converts Refund specific http response to
 ...
 */
public interface IRefundResponseHandler<T, J> {
	/**
	 * This method will be invoked by RefundInfraService to convert response to
	 ...
	 * 
	 * @param t Holds AdyenResponse object, refund response from rest HttpClient
	 * @return The PaymentCollectionOutput- Adapter's output object
	 */
	J applyRefundResponse(T t);
}
