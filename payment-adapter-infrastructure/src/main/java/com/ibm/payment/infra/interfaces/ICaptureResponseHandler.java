 ...
 * <ul>
 * <li>Apply Capture Response - converts capture specific http response to
 ...
 */
public interface ICaptureResponseHandler<T, J> {
	/**
	 * This method will be invoked by CaptureInfraService to convert response to
	 ...
	 * 
	 * @param t Holds AdyenResponse object, capture response from rest HttpClient
	 * @return The PaymentCollectionOutput- Adapter's output object
	 */
	J applyCaptureResponse(T t);
}
